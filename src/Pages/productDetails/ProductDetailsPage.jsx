            ...
            <div className="border-b border-gray-200 pb-4 mb-4">
              ...
              <div className="flex items-center mb-4">
                ...
                <span className="text-gray-600 text-sm">
                  {product.reviews.average}/5 ({product.reviews.count} reviews)
                </span>
              </div>
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-4 gap-2 mb-4">
                ...
                >
                  ...
                  <div className="font-semibold">${product.pricing.hourly}</div>
                </button>
                ...
                >
                  ...
                  <div className="font-semibold">${product.pricing.daily}</div>
                </button>
                ...
                >
                  ...
                  <div className="font-semibold">${product.pricing.weekly}</div>
                </button>
