    ...
    <div>
      <div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-[url('https://i.ibb.co.com/Fb1kbh21/div-card-one.webp')] bg-cover bg-center h-80  rounded-4xl ">
            <div className="pt-28 pl-18">
          ...
          <div className="bg-[url('https://i.ibb.co.com/SSwszwF/div-card-two.webp')] bg-cover bg-center h-96 rounded-b-4xl">
        ...
        <div className="bg-[url('https://i.ibb.co.com/v4Yqgvfz/div-card-three.webp')] bg-cover bg-center mt-10 h-96 rounded-4xl">
          <div className="pt-40 pl-18">
            <h1 className="text-2xl font-bold mb-5">The Best Cameras</h1>
            <p className="text-stone-700 font-semibold mb-1">from just </p>
            <p className="mb-6">
